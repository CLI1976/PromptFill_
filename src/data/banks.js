...
export const INITIAL_BANKS = {
  ...
  character_companion: {
    ...
    options: [
      ...
      { cn: "神力女超人 (Wonder Woman)", en: "Wonder Woman" },
      { cn: "鋼鐵人 (Iron Man)", en: "Iron Man" },
      { cn: "皮卡丘 (Pikachu)", en: "Pikachu" },
      { cn: "哥吉拉 (Godzilla)", en: "Godzilla" },
  ...
  clothing_male: {
    ...
    options: [
      ...
      { cn: "戰術背心與工作褲", en: "Tactical vest and cargo pants" },
      { cn: "寬鬆的灰色帽T", en: "Loose grey hoodie" },
  ...
  clothing_female: {
    ...
    options: [
      ...
      { cn: "黑色緊身連身衣", en: "Black tight bodysuit" },
  ...
  expressions: {
    ...
    options: [
      ...
      { cn: "羞澀、躲閃、紅暈", en: "Shy, Evasive, Blushing" },
  ...
  texture_zoom: {
    ...
    options: [
      ...
      { cn: "絲襪的勾絲細節", en: "Snagged details on silk stockings" },
  ...
  action_detail: {
    ...
    category: "action",
    options: [
      { cn: "戴著項圈的爬行", en: "Crawling with a collar" },
  ...
  special_view: {
    ...
    options: [
      ...
      { cn: "監視器的俯視視角", en: "Top-down view from a security camera" }
    ]
  },
  bag_content: {
    ...
    options: [
      ...
      { cn: "可愛的毛絨背包", en: "Cute plush backpack" },
  ...
  art_style: {
    ...
    category: "visual",
    options: [
      { cn: "高畫質的 2D 插畫風格", en: "High-quality 2D illustration style" },
      { cn: "寫實厚涂風格", en: "Realistic impasto style" },
  ...
  classic_scene: {
    ...
    options: [
      ...
      { cn: "神隱少女", en: "Spirited Away" },
      { cn: "動物方城市（Zootopia）", en: "Zootopia" },
      { cn: "宅男行不行", en: "The Big Bang Theory" },
      ...
      { cn: "權力遊戲君臨城城牆", en: "Game of Thrones - King's Landing Walls" },
  ...
  render_style: {
    ...
    options: [
      ...
      { cn: "公仔級實體渲染", en: "Figurine-level Physical Rendering" },
      { cn: "3D像素風格", en: "3D Pixel Art Style" },
      { cn: "手工毛線針織風格", en: "Hand-knitted Yarn Style" },
      { cn: "毛線針織", en: "Knitted Yarn" },
      { cn: "毛氈與黏土", en: "Felt and Clay" },
      { cn: "瓦楞紙板", en: "Cardboard" }
    ]
  },
  show_name: {
  ...
  character_name: {
    ...
    options: [
      ...
      { cn: "浩克", en: "Hulk" },
      { cn: "薩諾斯", en: "Thanos" },
      { cn: "Tifa Lockhart", en: "TifaLockhart" },
      { cn: "Cammy", en: "Cammy" },
      { cn: "鋼鐵人", en: "Iron Man" }
    ]
  },
  ...
  ratio: {
    ...
    category: "visual",
    options: [
      { cn: "3:4直構圖", en: "3:4 Vertical" },
      { cn: "9:16直構圖", en: "9:16 Vertical" },
  ...
  fashion_deconstruct: {
    ...
    category: "item",
    options: [
      { cn: "整齊折疊的外套和精緻的高跟鞋", en: "Neatly folded coat and exquisite high heels" },
  ...
  toy_companion: {
    ...
    category: "item",
    options: [
      { cn: "Labubu藝術公仔", en: "Labubu Art Toy" },
      { cn: "暴力熊積木熊", en: "Bearbrick" },
      { cn: "泡泡瑪特Molly", en: "Pop Mart Molly" },
  ...
  sticker_core: {
    ...
    category: "item",
    options: [
      { cn: "用戶穿著甜美約會裝的照片", en: "Photo of user in a sweet date outfit" },
      { cn: "復古搖滾樂團T恤穿搭", en: "Vintage rock band T-shirt outfit" },
  ...
  sticker_decor: {
    ...
    options: [
      ...
      { cn: "賽博故障風Glitch元素", en: "Cyberpunk glitch elements" }
    ]
  },
  action_pose: {
    ...
    category: "action",
    options: [
      { cn: "用手指在男人腦后比劃'兔耳朵'", en: "Using fingers to make 'bunny ears' behind the man's head" },
      { cn: "勾肩搭背比V字手勢", en: "Arm around shoulder making V sign" },
  ...
  school_uniform: {
    ...
    options: [
      ...
      { cn: "灰色針織外套和格子裙校服", en: "Grey cardigan and plaid skirt uniform" },
  ...
  building_cluster: {
    ...
    category: "location",
    options: [
      { cn: "扭曲的澀谷109大樓和其他建築林立", en: "Distorted Shibuya 109 building and other forest of buildings" },
  ...
  monster_element: {
    ...
    category: "character",
    options: [
      { cn: "巨大的粉色和藍色漸層卡通怪獸", en: "Giant pink and blue gradient cartoon monster" },
  ...
  travel_location: {
    ...
    options: [
      ...
      { cn: "日本白川鄉合掌村", en: "Ogimachi, Shirakawa, Japan" },
      { cn: "日本愛媛縣道後溫泉本館", en: "Dogo Onsen Main Building in Ehime, Japan" }
    ]
  },
  comic_scene: {
  ...
  designer: {
    ...
    category: "character",
    options: [
      { cn: "安東尼·高迪 (Antoni Gaudí)", en: "Antoni Gaudí" },
      ...
      { cn: "札哈·哈蒂 (Zaha Hadid)", en: "Zaha Hadid" },
  ...
  design_item: {
    ...
    options: [
      ...
      { cn: "拖拉機", en: "Tractor" },
      { cn: "機械式鍵盤", en: "Mechanical keyboard" },
  ...
  jewelry_style: {
    ...
    category: "item",
    options: [
      { cn: "精美的金色背鍊", en: "Fine gold back necklace" },
      { cn: "簡約銀色鏈條", en: "Minimalist silver chain" },
      { cn: "珍珠身體鍊", en: "Pearl body chain" },
      { cn: "鑽石露背項鍊", en: "Diamond back drop necklace" },
      { cn: "鑲嵌祖母綠墜飾的金項鍊", en: "gold necklace with emerald pendants" },
      { cn: "藍寶石耳環，捕捉了深邃的藍色色調與精湛的工藝", en: "pair of sapphire earrings, capturing the deep blue hues and fine craftsmanship" },
      { cn: "鑲紅寶石的頭飾，突顯了鮮豔的紅寶石與精緻的金屬工藝", en: "ruby-studded tiara, highlighting the vibrant red stones and delicate metalwork" },
      { cn: "鑲嵌寶石的胸針，展現出鮮豔的色彩與精緻的細節", en: "gemstone-encrusted brooch, showcasing the vibrant colors and fine details" },
      { cn: "藍寶石與鑽石吊墜，突顯藍色與白色寶石之間的對比", en: "sapphire and diamond pendant, highlighting the contrast between the blue and white stones" },
      { cn: "金綠寶石項鍊，突顯其精緻的珠飾工藝與鮮豔的色彩", en: "a gold and turquoise necklace, highlighting the intricate beadwork and vibrant colors" },
      { cn: "銀質紫水晶手鍊，捕捉了深邃的紫色寶石與精湛的工藝", en: "a silver and amethyst bracelet, capturing the deep purple stones and fine craftsmanship" },
      { cn: "銀質寵物名牌", en: "a silver pet tag" },
      { cn: "祖母綠吊墜背鍊", en: "Emerald pendant back necklace" }
    ]
  },
  flower_type: {
    ...
    category: "item",
    options: [
      { cn: "一束深紅色玫瑰", en: "A bouquet of deep red roses" },
      { cn: "優雅的白色海芋", en: "Elegant white calla lilies" },
      { cn: "淡粉色牡丹", en: "Pale pink peonies" },
      { cn: "名貴的深色蘭花", en: "Exotic dark orchids" },
      { cn: "乾枯的尤加利葉", en: "Dried eucalyptus leaves" },
      { cn: "鮮豔的向日葵", en: "Vibrant sunflowers" }
    ]
  }
};
...
export const INITIAL_DEFAULTS = {
  ...
  art_style: { cn: "高畫質的 2D 插畫風格", en: "High-quality 2D illustration style" },
  background_style: { cn: "漫畫網格筆記本", en: "Manga grid notebook" },
  fashion_deconstruct: { cn: "整齊折疊的外套和精緻的高跟鞋", en: "Neatly folded coat and exquisite high heels" },
  toy_companion: { cn: "Labubu藝術公仔", en: "Labubu Art Toy" },
  ...
  ratio: { cn: "3:4直構圖", en: "3:4 Vertical" },
  ...
  sticker_core: { cn: "用戶穿著甜美約會裝的照片", en: "Photo of user in a sweet date outfit" },
  sticker_decor: { cn: "手繪愛心、閃光符號", en: "Hand-drawn hearts, sparkle symbols" },
  action_pose: { cn: "用手指在男人腦后比劃'兔耳朵'", en: "Using fingers to make 'bunny ears' behind the man's head" },
  ...
  school_uniform: { cn: "灰色針織外套和格子裙校服", en: "Grey cardigan and plaid skirt uniform" },
  ...
  monster_element: { cn: "巨大的粉色和藍色漸層卡通怪獸", en: "Giant pink and blue gradient cartoon monster" },
  ...
  fruit: { cn: "檸檬", en: "Lemon" },
  jewelry_style: { cn: "精美的金色背鍊", en: "Fine gold back necklace" },
  flower_type: { cn: "一束深紅色玫瑰", en: "A bouquet of deep red roses" }
};